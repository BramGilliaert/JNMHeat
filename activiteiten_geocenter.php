...
$sql_query="SELECT MEDIAN(field_activiteit_locatie_lat) as lat_center,MEDIAN(field_activiteit_locatie_lon) as lon_center, tAlgemeen.organisator_19 as organiserende_afdeling
