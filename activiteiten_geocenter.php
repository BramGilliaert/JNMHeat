...
$sql_query="SELECT tEvent.entity_id,AVG(field_activiteit_locatie_lat) as lat_center,field_activiteit_locatie_lon as lon_center, tAlgemeen.organisator_19 as organiserende_afdeling
